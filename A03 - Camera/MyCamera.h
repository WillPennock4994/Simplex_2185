...
namespace Simplex
{
	...
	class MyCamera
	{
		...
		//names from aerospace terms
		glm::quat m_qPitch; // Elevation of camera
		glm::quat m_qYaw; // Bearing of camera
	...
	public:
		...
		*/
		...
		glm::quat GetYaw(void);//Getter for Yaw

		void SetYaw(glm::quat a_qYaw);//Setter for Yaw

		glm::quat GetPitch(void);//Getter for Pitch

		void SetPitch(glm::quat a_qPitch);//Setter for Pitch

		void rotateCamera(float fAngleX, float fAngleY);//rotation

		glm::quat GetOrientation(void);//Getter for Orientation

		void SetOrientation(glm::quat a_qOrientation);//Setter for Orientation
